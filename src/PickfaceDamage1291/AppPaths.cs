...
internal static class AppPaths
{
    ...
    public static readonly string PendingImages = Path.Combine(Images, "pending");
    public static readonly string Backup = Path.Combine(Root, "backup");
    public static readonly string Logs = Path.Combine(Root, "logs");
    public static readonly string DatabaseFile = Path.Combine(Data, "pickface.db");
    public static readonly string SettingsFile = Path.Combine(Data, "settings.json");
